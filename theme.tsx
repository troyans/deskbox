          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="max-w-3xl text-center lg:text-left">
              ...
              <h2 className="mt-6 text-3xl font-normal text-white sm:text-4xl lg:text-5xl xl:text-6xl">
                Dive into industry insights and best practices in using chatbots
            ...
            <div className="grid grid-cols-1 mt-12 gap-y-12 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-4 sm:mt-16 lg:mt-20 xl:mt-24">
              {pageMap.length !== 0 &&
                (pageMap[0] as any).children
                  ...
                  .map((x, index) => {
                    return (
                      <div className="relative group" key={`featured${index}`}>
                        {x.frontMatter?.image && (
                          <div className="overflow-hidden rounded-md aspect-w-4 aspect-h-3">
                            <img
                              className="object-cover w-full h-full transition-all duration-200 group-hover:scale-110 group-hover:rotate-3"
        ...
        <section className="py-12 bg-white sm:py-16 lg:py-20">
          <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="max-w-md">
              ...
              <p className="mt-4 text-sm font-normal leading-6 text-gray-500"></p>
            </div>
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-12 sm:mt-16 lg:grid lg:grid-cols-12 lg:gap-x-16 xl:gap-x-24">
              ...
              <article className="mt-12 prose lg:mt-0 lg:prose-lg lg:col-span-8 prose-blockquote:lg:text-xl prose-blockquote:lg:leading-9 prose-blockquote:not-italic prose-blockquote:border-none prose-blockquote:text-lg prose-blockquote:leading-8 prose-blockquote:p-0 prose-blockquote:lg:p-0 prose-blockquote:font-medium prose-blockquote:text-gray-900">
                <MDXProvider
                  components={{
                    ...
                    h3: (props: React.HTMLProps<HTMLHeadingElement>) => (
                      <h3
                        className="mb-4 text-xl text-gray-900 sm:text-2xl"
                        {...props}
                      />
                    ),
                    ul: (props: React.HTMLProps<HTMLUListElement>) => (
                      <ul
                        className="mb-4 space-y-1 list-disc list-outside pl-8"
                        {...props}
                      />
                    ),
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto overflow-hidden bg-white border border-gray-200">
            <div className="px-4 py-4 sm:p-6 lg:p-8">
              <div className="sm:flex sm:items-start gap-y-0 md:flex md:flex-row md:items-center">
                <img
                ...
                <div className="mt-2 sm:mt-0 sm:ml-8 gap-y-1 space-y-2 mx-auto items-center text-center lg:text-left">
