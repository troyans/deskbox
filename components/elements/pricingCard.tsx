...
import { PricingTier } from "@/types/app-types";
...
export default function PricingCard({ tier, userEmail }: PricingCardProps) {
  useEffect(() => {
        ...
        {tier.paymentProvider == "LemonSqueezy" ? (
          ...
          <Button
            onClickEvent={async () => {
              ...
              const sessionId = await stripeCheckout({ lineItems, userEmail });
